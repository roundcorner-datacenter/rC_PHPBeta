...
function show_accounts($instance_url, $access_token) {
		...
		$query = "SELECT Account, Id, Amount FROM Opportunity";
...
if ($pn < 1) { // If it is less than 1
    ...
    $pn = $lastPage; // force it to be $lastpage's value
		...
		$query = "SELECT Account, Id, Amount FROM Opportunity ORDER BY Id LIMIT 10 OFFSET $offset";
...
//////////////////////////////pagination/////////////////////////////////////////////////////////////////
		...
		$pn = preg_replace('#[^0-9]#i', '', $_GET['pn']); // filter everything but numbers for security(new)
    	$query = "SELECT Account, Id, Amount FROM Opportunity ORDER BY Id LIMIT 10 OFFSET 0";
