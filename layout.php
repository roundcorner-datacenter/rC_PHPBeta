...
function show_accounts($instance_url, $access_token) {
		...
		$query = "SELECT rC_Giving__Current_Amount__c, Id, rC_Giving__Account__c FROM rC_Giving__Summary__c";
...
if ($pn < 1) { // If it is less than 1
    ...
    $pn = $lastPage; // force it to be $lastpage's value
		...
		$query = "SELECT rC_Giving__Current_Amount__c, Id, rC_Giving__Account__c FROM rC_Giving__Summary__c ORDER BY Id LIMIT 10 OFFSET $offset";
...
//////////////////////////////pagination/////////////////////////////////////////////////////////////////
        ...
        $theDiv .= "<tr><td width='33%'>".$record['Id']."</td><td width='33%'>".$record['rC_Giving__Current_Amount__c']."</td><td width='33%'>$".$record['rC_Giving__Account__c']."</td></tr>";
    }
		
		$theDiv .= "</table></div></div>";
	}else{
		$pn = preg_replace('#[^0-9]#i', '', $_GET['pn']); // filter everything but numbers for security(new)
    	$query = "SELECT rC_Giving__Current_Amount__c, Id, rC_Giving__Account__c FROM rC_Giving__Summary__c ORDER BY Id LIMIT 10 OFFSET 0";
...
//////////////////////////////pagination/////////////////////////////////////////////////////////////////
    ...
    <div class='container'><div class='table-responsive' style='overflow: hidden;'><table class='table'><tr><td width='33%'><h3>ID</h3></td><td width='33%'><h3>rC_Giving__Current_Amount__c</h3></td><td width='33%'><h3>Account</h3></td></tr></table>";	
	echo $theDiv;
}
